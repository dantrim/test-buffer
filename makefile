...
# generated with `makeproject` on Wed Oct 12 02:03:01 CEST 2016
...
LIBS += -L/usr/local/opt/boost160/lib -lboost_thread-mt -lboost_system
INC += -I/usr/local/opt/boost160/include 
